...
class TextReader:
    ...
    def add_text(self, text: IMessage):
        """인스턴스 추가 메소드, type hinting 파라미터는 IMessage 인터페이스를 상속받을 것"""
...
email = Email('안녕? 잘 지내니?', 'young@gmail.copm')
text_message = TextMessage('내일 시간 가능? 1시쯤 만나자')

text_reader = TextReader() # 텍스트 리더기 
